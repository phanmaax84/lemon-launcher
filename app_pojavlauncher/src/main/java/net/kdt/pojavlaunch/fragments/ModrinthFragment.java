...
public class ModrinthFragment extends Fragment implements ModItemAdapter.SearchResultCallback {
    ...
    private TextView mSelectedProfileTextView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        mModItemAdapter = new ModItemAdapter(getResources(), mModrinthApi, this);
        ...
        if (Tools.isValidString(currentProfile)) {
            ...
            if (profile != null && profile.lastVersionId != null) {
                mSearchFilters.mcVersion = profile.lastVersionId;
            }
        }
